...
# Created by `pipx` on 2025-08-16 17:36:57
export PATH="$PATH:/home/j4ck1e/.local/bin"
...
# pnpm
export PNPM_HOME="/home/j4ck1e/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
export PATH="/home/j4ck1e/.deno/bin:$PATH"
...
alias la='exa -la --icons --group-directories-first -h'
alias lt='exa --tree --level=2 --icons'
alias lsg='exa -la --git --long --icons --group-directories-first'

alias c="batcat -p"

# for pomo project
alias buildwin='cargo xwin build --target x86_64-pc-windows-msvc'
alias buildwin-release='cargo xwin build --target x86_64-pc-windows-msvc --release'
